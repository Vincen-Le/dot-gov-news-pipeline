...
export const operatorRecipes: OperatorRecipe[] = [
  ...
  {
    cli: "pnpm ops inventory summary",
  ...
  {
    cli: "pnpm ops inventory runs --limit 10",
  ...
  {
    cli: "pnpm ops inventory sites --hostname nasa.gov",
  ...
  {
    cli: "pnpm ops events list --since 30m",
  ...
  {
    cli: "pnpm ops worker tail --search worker_lifecycle",
