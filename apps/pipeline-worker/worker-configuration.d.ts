/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: fd535034b36cc9ff0768ae2a18295af6)
// Runtime types generated with workerd@1.20260714.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	PIPELINE_EVENTS_QUEUE: Queue;
	SITE_DISCOVERY_QUEUE: Queue;
	BUILD_VERSION: string;
	DISCOVERY_CLAIM_LIMIT: string;
	DISCOVERY_CONTACT: string;
	DISCOVERY_ENABLED: string;
	DISCOVERY_LEASE_SECONDS: string;
	DISCOVERY_MAX_DELAY_SECONDS: string;
	DISCOVERY_MAX_PUBLISHER_REQUESTS: string;
	DISCOVERY_POLICY_VERSION: string;
	DISCOVERY_QUEUE_HIGH_WATER: string;
	DISCOVERY_SITE_DEADLINE_SECONDS: string;
	SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUILD_VERSION" | "DISCOVERY_CLAIM_LIMIT" | "DISCOVERY_CONTACT" | "DISCOVERY_ENABLED" | "DISCOVERY_LEASE_SECONDS" | "DISCOVERY_MAX_DELAY_SECONDS" | "DISCOVERY_MAX_PUBLISHER_REQUESTS" | "DISCOVERY_POLICY_VERSION" | "DISCOVERY_QUEUE_HIGH_WATER" | "DISCOVERY_SITE_DEADLINE_SECONDS" | "SUPABASE_URL" | "SUPABASE_SECRET_KEY">> {}
}
