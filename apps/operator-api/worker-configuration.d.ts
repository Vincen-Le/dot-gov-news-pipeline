/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 728095966886aa32a5f63e19551056c6)
...
interface __BaseEnv_Env {
  ...
  ENVIRONMENT: string;
  OPS_API_ENABLED: string;
  SUPABASE_URL: string;
  OPS_API_TOKEN: string;
  SUPABASE_SECRET_KEY: string;
  PIPELINE_WORKER: Fetcher /* dot-gov-news-pipeline-dev */;
}
