...
# process_entry, consumed by pipeline/simple/replay.py and tests/simple/test_simple_linker.py)
...
class Linker:
    ...
    def process_entry(self, row: dict, vec) -> dict:
        ...
        # closed by the driver (pipeline/simple/replay.py), which owns CardEngine.
    ...
    def _new_storyline(self, row: dict, vec, t: datetime, method: str,
        ...
        # (pipeline/simple/replay.py): it never gates linking, and inline LLM calls
