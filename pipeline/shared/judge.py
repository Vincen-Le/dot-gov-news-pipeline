...
Anthropic API (ANTHROPIC_API_KEY, loaded from .env by pipeline.shared.config).
"""
...
# expected verdict CSVs. Column contracts must match pipeline.shared.evals scoring.
