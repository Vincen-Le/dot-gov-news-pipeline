# Experiment: jul19-00-baseline

Duration: 3625.2s — processed 150, closed 140 episodes, cache 4 hits / 231 misses.

## Totals

- entries clustered: 150
- episodes: 140  storylines: 126  cards: 280
...
- [2 episodes] Kentucky Counties Affected by April Flooding and May Tornadoes Now Eligible for FEMA Public Assistance
...
- themes: 4  categories: 23 seed + 0 llm
- singleton-theme rate: 0.0

## LLM health

- overview fallback rate: 0.143
- uncategorized themes: 0
- deferred/unassigned storylines: 103
- theme creator errors: 0
- model errors: {'category_classifier': 2, 'adjudicator': 5}
...
- [7 storylines] International Conflict Diplomacy (Foreign Affairs & Trade)
- [7 storylines] Veteran Health Research (Veterans Affairs)
- [5 storylines] FEMA Disaster Relief (Disaster Response & Emergency)
