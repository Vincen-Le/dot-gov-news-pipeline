...
| Design + plan docs | inside tip: `docs/archive/implementation-plans/2026-07-19-ops-cli-ux-consolidation.md`, `2026-07-19-local-dev-onboarding.md` + design docs (commits `dfff978`, `c7f8220`, `99644fe`, `09927ce`) |
...
```bash
git show a52c35a:docs/archive/implementation-plans/2026-07-19-ops-cli-ux-consolidation.md > /tmp/ops-plan.md
git show a52c35a:docs/archive/implementation-plans/2026-07-19-local-dev-onboarding.md > /tmp/onboarding-plan.md
```
