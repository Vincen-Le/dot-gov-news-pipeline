...
**Specs honored:** `docs/archive/design-specs/2026-07-17-operator-dashboard-nds-design.md` (visual system, data honesty rules, shared inspector, CLI/cheatsheet parity, keyboard).
