...
**Specs this implements:** `docs/archive/design-specs/2026-07-18-storyline-event-cards-design.md` (schema section, lines 91–158) and the surviving audit-trail/junction model from `docs/archive/design-specs/2026-07-17-ranking-pipeline-design.md` (lines 205–262). Granularity additions (event_keys, entity_stats) from the 2026-07-18 X-clustering analysis discussion.
