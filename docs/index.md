...
| Run or QA the clustering pipeline and experiments              | [Evaluation harness runbook](operations/evaluation-harness.md)                                                            | [Clustering lab quick guide](operations/clustering-lab.md), [`pipeline/`](../pipeline), and [`apps/operator-console/src/lab`](../apps/operator-console/src/lab) |
...
| Improve storyline attachment in vector space                   | [Storyline vector representation spec](superpowers/specs/2026-07-18-storyline-vector-representation-hypotheses-design.md) | [Retrieval/enrichment hypotheses (H1–H3)](superpowers/specs/2026-07-18-clustering-retrieval-enrichment-hypotheses-design.md)                                    |
...
- An operator-console clustering lab (`pnpm ops lab …`) for corpus QA,
  experiments recorded in `complex_v1_experiment_runs`, quality metrics, and borderline
  labeling.
